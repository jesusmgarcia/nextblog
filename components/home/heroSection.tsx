...
const HeroSection = () => {
  return (
    <section className='relative min-h-150 w-full overflow-hidden bg-linear-to-br from-purple-950 via-indigo-950 to-indigo-950'>
      {/* Gradient overlay */}
      <div className='absolute inset-0 before:absolute before:left-1/4 before:top-0 before:h-150 before:w-125 before:rounded-full before:bg-linear-to-r before:from-violet-600/20 before:to-indigo-600/20 before:blur-3xl' />
      ...
      <div className='container relative mx-auto flex h-full flex-col items-center justify-center px-4 py-24 md:flex-row md:py-32'>
        ...
        <div className='flex-1 space-y-8 text-center md:text-left'>
          ...
          <p className='mx-auto max-w-2xl text-lg text-gray-300 md:text-xl'>
            Discover insightful articles, thought-provoking stories, and expert perspectives on
        ...
        <div className='mt-12 flex-1 md:mt-0'>
          <div
            className={cn(
              'relative mx-auto h-96 w-128 rounded-2xl overflow-hidden',
