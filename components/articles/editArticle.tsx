...
import { EditArticleAction } from '@/actions/editArticle';
import Image from 'next/image';
import { Articles } from '@/app/generated/prisma/client';
...
const EditArticle: React.FC<EditPropsPage> = ({ article }) => {
  const [content, setContent] = useState(article.content);
  const [formState, action, isPending] = useActionState(EditArticleAction.bind(null, article.id), {
    errors: {},
  });
            ...
            <div className='space-y-2'>
              ...
              {article.featuredImage && (
                <div className='mb-4'>
                  ...
                  />
                  {/*<p className='text-sm text-muted-foreground mt-2'>Current featured image</p>*/}
                </div>
              )}
