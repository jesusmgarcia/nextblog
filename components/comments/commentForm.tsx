...
const CommentForm: React.FC<CommentFormProps> = ({ articleId }) => {
  const [formState, action, isPending] = useActionState(CreateCommentAction.bind(null, articleId), {
    errors: {},
  });
  return (
      ...
      <div className='flex gap-4'>
        ...
        <div className='flex-1'>
          ...
          {formState.errors.body && (
            <p className='text-red-600 text-sm font-medium'>{formState.errors.body}</p>
          )}
